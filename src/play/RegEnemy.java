 ...
 * @author reeder
 */
public class RegEnemy extends JPanel{
    final static int DIAMETER = 30;
    private int x, y, uXPostiton, uYPostiton, xBound, yBound, width, height;
    private BufferedImage regEnemy;
    
    public RegEnemy(int uXPostiton, int uYPostiton, int panelWidth, int panelHeight) {
        Random r = new Random();
        int num = r.nextInt(4);
        ...
        try{
            regEnemy = ImageIO.read(new File("enemy.png"));
    ...
    public boolean checkForLoss(){
        Rectangle tempEnemy = new Rectangle(x,y, 21,21);
